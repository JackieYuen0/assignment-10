...
print(initial_missing_counts, initial_duplicate_count)
...
# Your code here
df_typed = raw_df
df_typed['join_date'] = pd.to_datetime(df_no_missing['join_date'], errors = 'raise', format = 'mixed')
df_typed['last_purchase'] = pd.to_datetime(df_no_missing['last_purchase'], errors = 'raise', format = 'mixed')
...
# Your code here
df_typed['total_spent'] = df_typed['total_spent']
print(df_typed['total_spent'])
...
# Your code here
df_text_cleaned = df_typed
df_text_cleaned['first_name'] = df_typed['first_name'].str.title()
df_text_cleaned['last_name'] = df_typed['last_name'].str.title()
...
# Your code here
phone_format = "000000000"
df_text_cleaned['phone'] = df_text_cleaned['phone']

print(df_text_cleaned['phone'])
